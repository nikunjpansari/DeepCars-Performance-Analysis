...
class GridWorld:
    ...
    def PygameInitialize(self):
        ...
        # images
        print(os.getcwd())
        self.PlayerImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/MyCar')
        self.PlayerImage = pygame.transform.scale(self.PlayerImage, (CarWidth, CarHeight))

        Car1Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/Car1')
        Car1Image = pygame.transform.scale(Car1Image, (CarWidth, CarHeight))
        Car2Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/Car2')
        Car2Image = pygame.transform.scale(Car2Image, (CarWidth, CarHeight))
        Car3Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/Car3')
        Car3Image = pygame.transform.scale(Car3Image, (CarWidth, CarHeight))
        Car4Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/Car4')
        Car4Image = pygame.transform.scale(Car4Image, (CarWidth, CarHeight))
        Car5Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/Car5')
        ...
        LeftWallImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/left')
        RightWallImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/right')

        self.LineImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/black_line')
        self.LineImage = pygame.transform.scale(self.LineImage, (LineWidth, WindowHeight))

        self.HorizLineImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/image/Horizontal_Dashes')
