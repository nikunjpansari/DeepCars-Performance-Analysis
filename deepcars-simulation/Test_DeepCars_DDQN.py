...
if __name__ == "__main__":
    ...
    agent.load("/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/Archive/DQN vs DDQN best performance/ARC_AVL_DDQN_8.h5")
    batch_size = 32
    ...
    while True:
        ...
        next_state, reward, done, HitCarsCount, PassedCarsCount = env.step(2)
        # time.sleep(.2)
        env.render()
