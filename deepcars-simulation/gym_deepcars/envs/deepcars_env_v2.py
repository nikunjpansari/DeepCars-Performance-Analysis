...
class DeepCarsEnv_v2(gym.Env):
    ...
    def __init__(self):
        ...
        self.PlayerImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/MyCar')
        self.PlayerImage = pygame.transform.scale(self.PlayerImage, (CarWidth, CarHeight))

        Car1Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/Car1')
        Car1Image = pygame.transform.scale(Car1Image, (CarWidth, CarHeight))
        Car2Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/Car2')
        Car2Image = pygame.transform.scale(Car2Image, (CarWidth, CarHeight))
        Car3Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/Car3')
        Car3Image = pygame.transform.scale(Car3Image, (CarWidth, CarHeight))
        Car4Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/Car4')
        Car4Image = pygame.transform.scale(Car4Image, (CarWidth, CarHeight))
        Car5Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/Car5')
        Car5Image = pygame.transform.scale(Car5Image, (CarWidth, CarHeight))
        Car6Image = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/Car6')
        ...
        LeftWallImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/left')
        RightWallImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/right')

        self.LineImage = pygame.image.load('/home/user/Documents/RL MINI Project/deepcars-reinforcement-learning/gym_deepcars/envs/assets/black')
